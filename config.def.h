...
static const Key keys[] = {
	...
	{MOD2KEY,                       XK_d,      spawn,          {.v = roficmd} },
	{MOD2KEY,                       XK_t,      spawn,          {.v = tmuxcmd} },
	{MOD2KEY,                       XK_f,      spawn,          {.v = filemgr} },
	{MOD2KEY,                       XK_e,      spawn,          {.v = editor} },
	{MOD2KEY,                       XK_b,      spawn,          {.v = browser} },
	...
	{ MOD2KEY,                      XK_Right,  viewnext,       {0} },
	{ MOD2KEY,                      XK_Left,   viewprev,       {0} },
	{ MOD2KEY|ShiftMask,            XK_Right,  tagtonext,      {0} },
	{ MOD2KEY|ShiftMask,            XK_Left,   tagtoprev,      {0} },
	TAGKEYS(                        XK_1,                      0)
	TAGKEYS(                        XK_2,                      1)
	TAGKEYS(                        XK_3,                      2)
	TAGKEYS(                        XK_4,                      3)
